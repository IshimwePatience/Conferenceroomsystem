        ...
        <form onSubmit={handleLoginSubmit} className="w-full max-w-sm">
            <div className="mb-6">
                <input 
                    ...
                    className="w-full px-4 py-2 bg-white/10 backdrop-blur-sm rounded-lg font-light text-white placeholder-white/70 hover:shadow-2xl focus:outline-none transition-all" 
            ...
            <button 
                type="submit" 
                className="w-full bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-500 text-white py-2 rounded-lg font-medium text-sm hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 mb-4"
            >
                Sign in
            </button>
            ...
            <button 
                ...
                className="w-full flex items-center justify-center py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white text-sm hover:bg-white/20 transition-all duration-300 mb-6"
            >
        ...
        <form onSubmit={handle2FASubmit} className="w-full max-w-sm">
            <div className="mb-6">
                <input 
                    ...
                    className="w-full px-4 py-3 bg-white/10 backdrop-blur-sm rounded-lg font-light text-white placeholder-white/70 hover:shadow-2xl focus:outline-none transition-all" 
            ...
            <div className="flex flex-col space-y-2">
                <button 
                    ...
                    className="w-full text-cyan-400 hover:text-cyan-300 transition-colors text-center"
                >
                    Resend Code
                </button>
                <button 
