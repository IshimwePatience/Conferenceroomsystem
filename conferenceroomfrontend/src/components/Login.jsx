    ...
    <span className="text-white text-fluid-xl font-semibold">ConferenceRoomBooking</span>
            ...
            <div className="flex-1 flex items-center justify-center relative z-10 px-6 py-6 md:px-4 md:py-4 scaled:px-6 scaled:py-6 md:overflow-y-auto lg:overflow-y-auto">
                <div className="w-full max-w-md">
                    {/* RBC Header Logo - Only visible on md and larger devices */}
                    <div className="hidden md:flex justify-center mb-8 lg:mb-10 xl:mb-10">
                        <img 
                            src={rbcheader} 
                            alt="RBC Logo" 
                            className="h-12 md:h-14 lg:h-16 xl:h-16 object-contain"
                        />
                    </div>
